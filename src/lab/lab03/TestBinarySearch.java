...
public class TestBinarySearch {
    ...
    private static void testArray(int[] testArray, int min, int max) {
        ...
        for (int i = 0; i < 20; ++i) {
            int a = StdRandom.uniformInt(0, size);
            int b = StdRandom.uniformInt(0, size);
            int key = StdRandom.uniformInt(min, max);
